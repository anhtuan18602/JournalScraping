...
if __name__ == '__main__':
    ...
    years = (2024, 2024) #First and Last year to extract
    
    ## Specify Chrome installation path for Selenium
    binary_location = "C:\Program Files\Google\Chrome\Application\chrome.exe"

    journal = 'mnsc' #Journal shortname
    keywords = [
            'experiment',
            'experiments',
            'experimental',
    ...
    journal_map = {
            ...
            'mnsc': {'publisher': 'INFORMS', 'identifier': 'mnsc','name':'Management Science Journal'},
    ...
    if publisher == "elsevier":
        ...
        print(years)
        print(search_inputs)
        SearchProvider = get_search_provider(search_inputs['publisher'], search_inputs['shortname'], search_inputs['identifiers'], binary_location, keywords, year_range=years)
        ...
        if publisher in ["oxford","wiley","INFORMS"]:
